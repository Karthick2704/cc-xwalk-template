...
## Environments
- Preview: https://main--cc-xwalk-template--Karthick2704.aem.page/
- Live: https://main--cc-xwalk-template--Karthick2704.aem.live/
...
1. Open the `cc-xwalk-template` directory in your favorite IDE and start coding :)
